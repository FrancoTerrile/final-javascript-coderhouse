...
const renderProductos = () => {
    ...
    productos.forEach(producto => {
        ...
        <div class="card-body">
          ...
          <p class="card-text" id="${producto.id}">ARS${producto.precioPesos}</p>
...
const renderCarrito = () => {
    ...
    if (cantProductosCarrito() > 0) {
        ...
        productos.forEach(producto => {
            ...
            <td class="align-middle">USD${producto.precio}</td>
...
const callApi = () => {
    ...
    .then(function (data){
        ...
        for (let i = 0; i < productos.length; i++) {
            ...
            element.precioPesos = element.precio * data.blue.value_sell;
            document.getElementById(element.id).innerHTML = `ARS ${element.precioPesos}`
        }
    })
